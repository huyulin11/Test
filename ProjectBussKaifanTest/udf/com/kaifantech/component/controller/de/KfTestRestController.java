...
import com.kaifantech.util.constant.taskexe.ctrl.AgvCmdCtrlTask;
...
public class KfTestRestController {
	...
	@RequestMapping("addCtrlTask2")
	@ResponseBody
	public JSONObject addCtrlTask(String tasktype, Integer agvId) {
		try {
			AppMsg appMsg = AgvCmdCtrlTask.addCtrlTask(tasktype, agvId);
			if (appMsg.isSuccess())
				return appMsg.toAlbbJson();
