...
import static com.kaifantech.util.serial.purejavacomm.PureJavaCommChannelOption.*;
...
public class PureJavaCommChannel extends OioByteStreamChannel {
	...
	protected void doInit() throws Exception {
		serialPort.setSerialPortParams(config().getOption(BAUD_RATE), config().getOption(DATA_BITS).value(),
